...
public interface HomeworkStuDao {
    ...
    //条件查询总条数
    Integer queryPageTotalCountsByHwNameAndEndtimeAndStatus(int course_id, String hw_name, String end_time, String correct_status);

    //分页查询
    List<HomeworkStu> queryHomeworkStuByPage(int pageNo, int pageSize);

    //条件分页查询:
    List<HomeworkStuManageInfo> queryHomeworkStuByHwNameAndEndtimeAndStatus(int pageNo, int pageSize, int course_id, String hw_name, String end_time, String correct_status);
}
