...
public class HomeworkStuServlet extends BaseServlet{
    ...
    public void queryHomeworkStuByHwNameAndEndtimeAndStatus(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        Integer homework_id= Integer.valueOf(request.getParameter("homework_id"));
        ...
        Page<HomeworkStuManageInfo> page=homeworkStuService.queryHomeworkStuByHwNameAndEndtimeAndStatus(pageNum,Page.PAGE_SIZE,course_id,homework_id,homework_name,end_time,correct_status);
        Gson gson = new Gson();
